...
/**
 *
 * <code>SexEnumTypeHandler<code> <strong></strong>
 * <p>
 * 说明：
 * <li></li>
 * </p>
 * 
 * @since
 * @version 2017年10月15日 下午3:13:47
 * @author libinf
 */

public class SexEnumTypeHandler extends BaseTypeHandler<Sex> {
	private Class<Sex> type;
	private final Sex[] enums;
	 ...
	 * @return code对应的枚举类
	 */
	private Sex locateEnumStatus(int code) {
		for (Sex enumValue : enums) {
