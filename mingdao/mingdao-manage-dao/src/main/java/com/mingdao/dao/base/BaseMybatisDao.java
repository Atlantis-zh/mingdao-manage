...
import com.mingdao.dao.base.page.MysqlDialect;
import com.mingdao.dao.base.page.Paginable;
import com.mingdao.dao.base.page.Pagination;
...
public class BaseMybatisDao<T> extends SqlSessionDaoSupport {
	...
	public Paginable findByPageBySqlId(String sqlId,
