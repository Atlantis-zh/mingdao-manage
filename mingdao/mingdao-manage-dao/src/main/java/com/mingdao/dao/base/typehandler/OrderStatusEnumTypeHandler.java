...
/**
 *
 * <code>OrderStatusEnumTypeHandler<code> <strong></strong>
 * <p>
 * 说明：
 * <li></li>
 * </p>
 * 
 * @since
 * @version 2017年10月17日 下午6:49:28
 * @author libinf
 */

public class OrderStatusEnumTypeHandler extends BaseTypeHandler<OrderStatus> {

	private Class<OrderStatus> type;

	private final OrderStatus[] enums;

	public OrderStatusEnumTypeHandler(Class<OrderStatus> type) {
		if (type == null)
	...
	private OrderStatus locateEnumStatus(int code) {
		for (OrderStatus enumValue : enums) {
