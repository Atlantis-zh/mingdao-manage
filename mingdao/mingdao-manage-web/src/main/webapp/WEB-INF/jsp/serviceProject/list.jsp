							...
							<table style="width: 100%;">
								...
								<tr>
									<td style="vertical-align: top;">
										...
										<a href="<%=request.getContextPath() %>/serviceProject/serviceProjects" style="color:#FFF;text-decoration:none;" class="btn btn-info fa fa-refresh" title="刷新列表"></a>
									</td>
									<td style="vertical-align: top;">
										<c:if test="${datas.total > 0}">
											<jsp:include page="/jsp/pager.jsp">
												<jsp:param value="${datas.total }" name="totalRecord"/>
												<jsp:param value="serviceProjects" name="url"/>
											</jsp:include>
										</c:if>
									</td>
								</tr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" id="searchhdfbox_grid-table_add"
				 style="cursor: move;">
				<div class="widget-header">
					<span class="ui-jqdialog-title" id="modalTitle" style="float: left;">新增服务项目</span>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
						&times;
					</button>
				</div>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="code">项目编码: </label>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input id="cost" placeholder="cost" class="col-xs-10 col-sm-5" type="text">
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="workHours">  工时: </label>

								<div class="col-sm-9">
									<input id="workHours" placeholder="workHours" class="col-xs-10 col-sm-5" type="text">
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="salePrice"> 报价: </label>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input id="unit" placeholder="unit" class="col-xs-10 col-sm-5" type="text">
								</div>
							</div>
