...
<script src="<%=request.getContextPath() %>/resources/ace/assets/js/jquery.dataTables.bootstrap.js"></script>
	...
	<script type="text/javascript">
		    function getSelecOption(){
				...
				parent.document.getElementById("custTypeId").value = array[0];
				parent.document.getElementById("custTypeName").value = array[1];
				parent.document.getElementById("custTypeList").style.display="none";
			}
			...
			$("#fbox_grid-table_search").click(function(){
				...
				submitForm("<%=request.getContextPath() %>/custTypeBaseSer/refCustType",paramsArr);
	    	});
	</script>
