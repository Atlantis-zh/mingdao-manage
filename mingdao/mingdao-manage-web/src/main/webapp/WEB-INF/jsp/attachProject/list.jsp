									...
									<tbody>
										<tr>
											<td style="vertical-align: top;">
												...
												<a href="<%=request.getContextPath() %>/attachProject/attachProjects" style="color:#FFF;text-decoration:none;" class="btn btn-info fa fa-refresh" title="刷新列表"></a>
											</td>
											<td style="vertical-align: top;">
												<c:if test="${datas.total > 0}">
														<jsp:include page="/jsp/pager.jsp">
														<jsp:param value="${datas.total }" name="totalRecord"/>
														<jsp:param value="attachProjects" name="url"/>
													</jsp:include>
												</c:if>
											</td>
										</tr>
...
<script src="<%=request.getContextPath() %>/resources/ace/assets/js/jquery.dataTables.bootstrap.js"></script>
	...
	<script type="text/javascript">
			...
			$("#fbox_grid-table_search").click(function(){
				...
				submitForm("<%=request.getContextPath() %>/attachProject/attachProjects",paramsArr);
	    	});
			...
			$("#fbox_grid-table_add").click(function(){
				...
				$.ajax({
					...
					success: function (data, status) {
						...
						submitForm("<%=request.getContextPath() %>/attachProject/attachProjects",null);
					},
