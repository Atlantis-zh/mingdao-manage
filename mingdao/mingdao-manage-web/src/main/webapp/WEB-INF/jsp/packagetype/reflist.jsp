...
<script src="<%=request.getContextPath() %>/resources/ace/assets/js/jquery.dataTables.bootstrap.js"></script>
	...
	<script type="text/javascript">
		    function getSelecOption(){
				...
				parent.document.getElementById("packageTypeId").value = array[0];
				parent.document.getElementById("packageType").value = array[1];
				parent.document.getElementById("packageTypeList").style.display="none";
			}
