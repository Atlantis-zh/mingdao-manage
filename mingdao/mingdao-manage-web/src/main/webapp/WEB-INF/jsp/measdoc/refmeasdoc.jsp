										...
										<tr>
											<td style="vertical-align: top;">
												<c:if test="${datas.total > 0}">
														...
														<jsp:param value="refmeasdoc" name="url"/>
													</jsp:include>
												</c:if>
											</td>
										</tr>
...
<script src="<%=request.getContextPath() %>/resources/ace/assets/js/jquery.dataTables.bootstrap.js"></script>
	...
	<script type="text/javascript">
		    function getSelecOption(){
				...
				parent.document.getElementById("measdocId").value = array[0];
				parent.document.getElementById("measdocName").value = array[1];
				parent.document.getElementById("measdocList").style.display="none";
			}
			...
			$("#fbox_grid-table_search").click(function(){
				...
				submitForm("<%=request.getContextPath() %>/measdocBaseSer/refmeasdoc",paramsArr);
	    	});
	</script>
