					...
					<div id="fbox_grid-table" class="searchFilter" style="overflow:auto">
						<table class="group ui-widget ui-widget-content ui-search-table" style="border:0px none;">
							...
							<tr>
								...
								<td class="data">
									<input type="text" id="search_name" name="search_name" role="textbox"
										...
										<tr>
											<td style="vertical-align: top;">
												<c:if test="${datas.total > 0}">
														...
														<jsp:param value="refworktimeclass" name="url"/>
													</jsp:include>
												</c:if>
											</td>
										</tr>
...
<script src="<%=request.getContextPath() %>/resources/ace/assets/js/jquery.dataTables.bootstrap.js"></script>
	...
	<script type="text/javascript">
		    function getSelecOption(){
				...
				parent.document.getElementById("workTimeClassId").value = array[0];
				parent.document.getElementById("workTimeClassName").value = array[1];
				parent.document.getElementById("workTimeClassList").style.display="none";
			}
			...
			$("#fbox_grid-table_search").click(function(){
				...
				submitForm("<%=request.getContextPath() %>/wktBaseSer/refworkTimeClasss",paramsArr);
	    	});
	</script>
